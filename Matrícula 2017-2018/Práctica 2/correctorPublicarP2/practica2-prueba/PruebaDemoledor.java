 ...
 * Se crean dos terrenos y productos que se colocan en los terrenos. Se crean
 * dos demoledores y un plebeyo. Se invoca domestica del plebeyo con una de las
 * bestias. Se invoca pasturea, busca, getFuerza, getNombre, getAmo  y getAmuleto de cada
...
public class PruebaDemoledor {
	...
	private static String mrf(double db){
	     ...
	     if(solar!=null){
	       for(int i=0;i<solar.getFilas();i++){
	         for(int j=0;j<solar.getColumnas();j++){
	           PruebaDemoledor.muestraTipo(solar.consultaTipo(i,j));
	         }
	         System.out.println();
	       }
	     }
	   ...
	   private static void veoDatos(Producto p){
	     if(p!=null){
	       System.out.println("Tipo: "+p.getTipo()+"; Nombre: "+p.getNombre()+"; peso: "+PruebaDemoledor.mrf(p.getPeso()));
	     }
	   }
	   ...
	   private static void muestraProductos(ArrayList<Producto> lista){
	    if(lista!=null){
	     ...
	     for(int j=0;j<lista.size();j++)
	         PruebaDemoledor.veoDatos(lista.get(j));
	    }
	   }
	   ...
	   private static void datosBestia(Bestia pet){
	     if(pet!=null){
	       ...
	       System.out.print("Fuerza: "+PruebaDemoledor.mrf(f)+"; Amuleto -> ");
	       PruebaDemoledor.veoDatos(a);
	     }
	   }


	   public static void main(String[] args){
	     int[] tipos=PruebaDemoledor.creaTipos();
	     String[][] names=PruebaDemoledor.creaNombres();
	     double pinicial=1.5;
	     ArrayList<Producto> existencias=PruebaDemoledor.creaProductos(names,tipos,pinicial,0.2);
	     ...
	     PruebaDemoledor.colocaProductos(solar,campo,existencias);
	     System.out.println("Terreno solar:");
	     PruebaDemoledor.consultaTerreno(solar);
	     System.out.println("Terreno campo:");
	     PruebaDemoledor.consultaTerreno(campo);
	     ...
	     if(name!=null)
	      System.out.println("Productos devueltos por pasturea de "+name+" en campo ("+PruebaDemoledor.mrf(casera.getFuerza())+")");
	     else
	      System.out.println("Productos devueltos por pasturea de sin nombre en campo("+PruebaDemoledor.mrf(casera.getFuerza())+")");
	     PruebaDemoledor.muestraProductos(ret);
	     name=salvaje.getNombre();
	     if(name!=null)
	      System.out.println("Productos devueltos por pasturea de "+name+" en solar ("+PruebaDemoledor.mrf(salvaje.getFuerza())+")");
	     else
	      System.out.println("Productos devueltos por pasturea de sin nombre en solar ("+PruebaDemoledor.mrf(salvaje.getFuerza())+")");
	     PruebaDemoledor.muestraProductos(reto);
	     System.out.println("Terreno solar:");
	     PruebaDemoledor.consultaTerreno(solar);
	     System.out.println("Terreno campo:");
	     PruebaDemoledor.consultaTerreno(campo);
	     ...
	     System.out.println("Terreno campo:");
	     PruebaDemoledor.consultaTerreno(campo);
	     PruebaDemoledor.datosBestia(casera);
	     PruebaDemoledor.datosBestia(salvaje);
	  }
