...
* dos bestias y un plebeyo. Se invoca domestica del plebeyo con una de las
...
public class p01{
  ...
  private static String mrf(double db){
     ...
     if(solar!=null){
       for(int i=0;i<solar.getFilas();i++){
         for(int j=0;j<solar.getColumnas();j++){
           p01.muestraTipo(solar.consultaTipo(i,j));
         }
         System.out.println();
       }
     }
   ...
   private static void veoDatos(Producto p){
     if(p!=null){
       System.out.println("Tipo: "+p.getTipo()+"; Nombre: "+p.getNombre()+"; peso: "+p01.mrf(p.getPeso()));
     }
   }
   ...
   private static void datosBestia(Bestia pet){
     if(pet!=null){
       ...
       System.out.print("Fuerza: "+p01.mrf(f)+"; Amuleto -> ");
       p01.veoDatos(a);
     }
   }
   ...
   public static void main(String[] args){
     ...
     double pinicial=1.5;
     ArrayList<Producto> existencias=p01.creaProductos(names,tipos,pinicial,0.2);
     Plebeyo doe=new Plebeyo("Eara Duncan",'M');
     Bestia salvaje=new Bestia(7);
     Bestia casera=new Bestia(12);
     Terreno solar=new Terreno(3,3);
     Terreno campo=new Terreno(3,4);
     p01.colocaProductos(solar,campo,existencias);
     System.out.println("Terreno solar:");
     p01.consultaTerreno(solar);
     System.out.println("Terreno campo:");
     p01.consultaTerreno(campo);
     ...
     if(name!=null)
      System.out.println("Productos devueltos por pasturea de "+name+" en campo ("+p01.mrf(casera.getFuerza())+")");
     else
      System.out.println("Productos devueltos por pasturea de sin nombre en campo("+p01.mrf(casera.getFuerza())+")");
     p01.muestraProductos(ret);
     name=salvaje.getNombre();
     if(name!=null)
      System.out.println("Productos devueltos por pasturea de "+name+" en solar ("+p01.mrf(salvaje.getFuerza())+")");
     else
      System.out.println("Productos devueltos por pasturea de sin nombre en solar ("+p01.mrf(salvaje.getFuerza())+")");
     p01.muestraProductos(reto);
     System.out.println("Terreno solar:");
     p01.consultaTerreno(solar);
     System.out.println("Terreno campo:");
     p01.consultaTerreno(campo);
     ...
     System.out.println("Terreno campo:");
     p01.consultaTerreno(campo);
     p01.datosBestia(casera);
     p01.datosBestia(salvaje);
  }
}   
