 ...
 * metodo completo de personaje. Mostramos los resultados por pantalla.
 */
...
public class p06acv {
	...
	private static ArrayList<Rasgo> getRasgos() {
		...
		rasgos.get(3).setAtributo("calvo");
	...
	public static void main(String[] args) {
		...
		String[] names = p06acv.getNombres(), atr = p06acv.getAtributos();
		p06acv.creaRasgos(giren, names, atr);
		System.out.println(giren);
		ArrayList<Rasgo> rasgos = p06acv.getRasgos();
		p06acv.consultando(rasgos,giren);
	}
