...
public class Huerta {
	...
	// metodo similar a abona pero en este comparamos los nombres de los frutos que producen
	public int abonaFrutos(int p, String n) {
		int devuelve_ = 0;
	...
	// metodo similar a abona pero exclusivo para trifidos
	public int abonaTrifidos(int p) {
		int devuelve_ = 0;
